...
Tôi sẽ tái sử dụng hàm `LaSNT` (Kiểm tra số nguyên tố) từ file `MaTran.cpp` và logic sắp xếp mảng 1 chiều để áp dụng cho từng hàng của ma trận.
...
// (Logic tuong tu file MaTran.cpp)
